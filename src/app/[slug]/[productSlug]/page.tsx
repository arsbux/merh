...
export default async function ProductPage({
    ...
    return (
        <div className="min-h-screen w-full bg-[#000000] flex items-center justify-center md:py-10 font-sans selection:bg-purple-500/30 selection:text-white">
            <div className="w-full max-w-[440px] bg-zinc-900 md:rounded-2xl overflow-hidden shadow-2xl relative text-white h-full md:h-auto md:min-h-[90vh] flex flex-col animate-in fade-in zoom-in-95 duration-500 border border-white/5">
